...
in=/mnt/picea/projects/spruce/sjansson/seasonal-needles/u2015030/raw_data

out=/mnt/picea/projects/spruce/sjansson/seasonal-needles/u2015030/
...
if [ -z ../UPSCb-common ]; then # -z teste si on a la variable UPSCb dans notre environnement
...
do 
bash ../UPSCb-common/pipeline/runRNASeqPreprocessing.sh -s $start -e $end -m $mem -g $genome -G $gtf -H $gff3 -f $kallistoFasta -K $kallistoIndex $proj $mail ${line}_1.fastq.gz ${line}_2.fastq.gz $out 
