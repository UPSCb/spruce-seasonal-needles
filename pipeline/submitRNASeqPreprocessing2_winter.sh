...
out=/mnt/picea/projects/spruce/sjansson/seasonal-needles/20170808/20180123/
...
do
bash ../UPSCb-common/pipeline/runRNASeqPreprocessing.sh -s $start -e $end -m $mem -g $genome -G $gtf -H $gff3 -I 70000 -f $kallistoFasta -K $kallistoIndex $proj $mail ${line}_1.fastq.gz ${line}_2.fastq.gz $out
done
